...
ADD CONSTRAINT store_id_fn
  ...
  -- loading data into product_info
...
-- loading data into customer_info
...
(200,'Fakaruddin','Tripathi','male','fakarthi@gmail.com');
 ...
 -- loading data into branch_details
...
(10,'Store B','Andheri','Mumbai','Maharashtra');
 ...
 -- loading data into order_product_mapping
...
SELECT COUNT(*)
FROM sales_fact sf
JOIN customer_info c ON sf.customer_id = c.customer_id
WHERE c.gender = 'male';
...
SELECT city, COUNT(*) AS quantity_ordered
FROM order_product_mapping
JOIN stores ON order_produc.store_id = sales_fact.store_id
GROUP BY city
...
SELECT area, SUM(sale_price) AS total_sales_amount
FROM product_info
JOIN branch_details ON sales_fact.store_id = branch_details.store_id
GROUP BY area
